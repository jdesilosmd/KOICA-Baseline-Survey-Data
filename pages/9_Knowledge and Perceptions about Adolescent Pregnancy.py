...
# Display title
st.title("9. Knowledge and Percceptons About Pregnancy")
...
create_expander_and_graph(18, 41, "Who do you think should have talked to you about sex and sexual health?", "Who do you think should have talked to you about sex and sexual health?", display_type)
create_expander_and_graph(43, 51, "Where would you seek help if you had a reproductive health question or problem?", "Where would you seek help if you had a reproductive health question or problem?", display_type)
create_expander_and_graph(52, 69, "To whom would you seek help if you had a reproductive health question or problem?", "To whom would you seek help if you had a reproductive health question or problem?", display_type)
create_expander_and_graph(70, 83, "What information would you want to know about ASRH?", "What information would you want to know about ASRH?", display_type)
create_expander_and_graph(90, 101, "Which contraceptive methods are most commonly used?", "Which contraceptive methods are most commonly used?", display_type)
